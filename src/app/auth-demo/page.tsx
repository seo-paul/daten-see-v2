    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Authentication Success! 🎉</h1>
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-blue-800 mb-2">🔧 Development Info</h3>
            ...
            <div className="mt-4 p-3 bg-white rounded border">
              <h4 className="font-semibold text-blue-800 mb-2">🔍 Check DevTools:</h4>
