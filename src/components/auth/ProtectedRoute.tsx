...
export function ProtectedRoute({
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FEFCF9]">
        <div className="text-center">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#2F4F73] mx-auto mb-4"></div>
          <p className="text-[#3d3d3d]/70">Checking authentication...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FEFCF9]">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-[#3d3d3d] mb-2">Access Denied</h1>
        <p className="text-[#3d3d3d]/70">You don&apos;t have permission to access this page.</p>
      </div>
    </div>
  );
}
